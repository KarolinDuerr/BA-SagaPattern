...
public class BookTripSaga {
    ...
    public void bookTrip(final BookTripSagaData bookTripSagaData) {
        ...
        processVariables.put(CustomerServiceTopics.DataInput.VALIDATE_CUSTOMER_DATA,
        ...
        camunda.getRuntimeService().startProcessInstanceByKey(TravelServiceTopics.Sagas.BOOK_TRIP_SAGA, processVariables);
    }
}
