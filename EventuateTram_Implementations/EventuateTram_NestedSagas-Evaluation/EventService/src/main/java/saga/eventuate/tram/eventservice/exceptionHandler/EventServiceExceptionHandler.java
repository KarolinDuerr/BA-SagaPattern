package saga.eventuate.tram.eventservice.exceptionHandler;
...
import saga.eventuate.tram.eventservice.error.*;
...
public class EventServiceExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handle(final EventServiceException exception, final WebRequest webRequest) {
