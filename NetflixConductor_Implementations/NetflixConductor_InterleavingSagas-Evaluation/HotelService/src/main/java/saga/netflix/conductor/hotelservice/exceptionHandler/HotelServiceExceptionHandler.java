package saga.netflix.conductor.hotelservice.exceptionHandler;
...
import saga.netflix.conductor.hotelservice.error.*;
...
public class HotelServiceExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handle(final HotelServiceException exception, final WebRequest webRequest) {
