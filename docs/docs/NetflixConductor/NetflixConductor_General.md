...
missing information, has to be sent as POST request to the Conductor server at: [`http://localhost:8080/tasks`](http://localhost:8080/tasks)
...
The UI can be accessed via [http://localhost:5000/](http://localhost:5000/).
...
[:octicons-mark-github-16: NetflixConductor_Implementations/NetflixConductor](https://github.com/KarolinDuerr/BA-SagaPattern/tree/master/NetflixConductor_Implementations/NetflixConductor)
