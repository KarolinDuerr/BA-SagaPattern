...
public class DtoConverter {
    ...
    public HotelBookingInformation convertToHotelBookingInformation(BookHotelRequest bookHotelRequest) throws ConverterException {
    ...
    public StayDurationDTO convertToStayDurationDTO(StayDuration stayDuration) throws ConverterException {
        ...
        return new StayDurationDTO(stayDuration.getStartDate(), stayDuration.getEndDate());
    }
}
