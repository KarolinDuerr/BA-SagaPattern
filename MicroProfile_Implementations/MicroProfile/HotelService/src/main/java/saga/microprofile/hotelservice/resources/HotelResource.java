...
//            return Response.ok(bookingResponse).entity(bookingResponse).build();
...
//                return Response.serverError(new NoHotelAvailable(bookHotelRequest.getTripId())).build(); // TODO
    ...
    public Response cancelHotel(@HeaderParam(LRA_HTTP_CONTEXT_HEADER) String lraId,
                                @RequestBody final CancelHotelBooking cancelHotelBooking) {
        logger.info("Compensate LRA (ID: " + lraId + ") --> Cancelling hotel for trip ID: " + cancelHotelBooking.getTripId());
    ...
    public Response confirmHotel(@HeaderParam(LRA_HTTP_CONTEXT_HEADER) String lraId,
                                 @RequestBody final ConfirmHotelBooking confirmHotelBooking) {
        logger.info("Complete LRA (ID: " + lraId + ") --> Confirming the hotel for trip ID: " + confirmHotelBooking.getTripId());
